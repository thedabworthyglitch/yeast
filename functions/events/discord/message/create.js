...
if (message.content.startsWith('!setup')) {
  ...
  if (!channelId)
    return lib.discord.channels['@0.2.0'].messages.create({
      content: `Please mention the channel where you want to setup the music bot.`,
  ...
  const msg = await lib.discord.channels['@0.2.0'].messages.create({
    ...
    embed: {
      ...
      description: `This is the music bot, created by \`utkarsh#2323\`.`,
      color: 0xD43790,
      image: {
        url: 'https://c.tenor.com/9yn1l4ukGW8AAAAC/cat-vibe.gif',
      },
      thumbnail: {
        url: 'https://cdn.discordapp.com/avatars/838093477257805834/fab5fc25a840e80e00c815973f070c59.webp?size=1024',
      },
    },
  });
